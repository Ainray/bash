#!/bin/gnuplot
# author: Ainray
# date: Sat Dec 23 13:53:47 CST 2017

set terminal push
set terminal epscairo transparent enhanced font 'Sans Bold,12' fontscale 0.4 size 7cm,7cm linewidth 0.5
set output 'test_dsp_fft1_spec.eps'
set encoding utf8
